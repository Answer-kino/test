          ...
          <View style={{height: '100%', alignItems: 'center'}}>
            <View
              ...
              <View style={{marginTop: '3%'}}>
                ...
                <Text style={styles.text}>8. 링크사이트</Text>
                <Text style={styles.text5}>
                ...
                <Text style={styles.text2}>1) 기술적 대책</Text>
                <Text style={styles.text5}>
                ...
                <Text style={styles.text2}>2) 관리적 대책</Text>
                <Text style={styles.text3}>
                ...
                <Text style={styles.text}>12. 권익침해 구제방법</Text>
                <Text style={styles.text2}>
                ...
                <View>
                  ...
                  <Text style={styles.text6}>전화 : (국번없이)118</Text>
                  <Text style={styles.text6}>
                    주소 : (58324)전남 나주시 진흥길 9(빛가람동 301-2) 3층
                    개인정보침해신고센터
                  </Text>
                  <Text style={styles.text3}>2. 개인정보 분쟁조정위원회</Text>
                  <Text style={styles.text6}>
                    소관업무 : 개인정보 분쟁조정신청, 집단분쟁조정(민사적 해결)
                  </Text>
                  <Text style={styles.text6}>웹사이트 : www.kopico.go.kr</Text>
                  <Text style={styles.text6}>전화 : (국번없이)18336972</Text>
                  <Text style={styles.text6}>
